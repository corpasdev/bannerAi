...
export const RightPanel: React.FC<RightPanelProps> = ({ currentStep, totalSteps }) => {
  ...
  return (
    <div className="h-full flex flex-col">
      ...
      <div className="w-full flex flex-col gap-3 p-5 mb-5 border-b border-slate-100 min-h-[100px]">
            <Button 
              disabled
      ...
      <ScrollArea className="flex-1">
        <div className="p-5 accordion-wrapper accordion-smooth">
          <Accordion 
            type="single" 
            collapsible
            defaultValue="layout"
